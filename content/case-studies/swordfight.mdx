...
writing one subclass, with no copy-pasted combat logic and no regressions in
existing weapons. This is what let the roster grow quickly late in development.
...
Shipped on Google Play and itch.io. 150k page views and 4.5★ from 111 ratings on
itch.io, 14 characters, and a community that still leaves comments calling it a
hidden gem.
